...
namespace TarodevController
{
    ...
    public class PlayerController : MonoBehaviour, IPlayerController
    {
        ...
        private void GatherInput()
        {
            ...
            {
                JumpDown = _input.Jump == PlayerInputManager.InputSate.Started,
                JumpUp = _input.Jump == PlayerInputManager.InputSate.Preformed,
                X = _input.MovementVector.x
            };
            if (Input.JumpDown)
            {
        ...
        {
            if (_colDown) // On Ground
            {
                // If On the Gound Set speed to 0 so that the body doesn't go bellow
            ...
            else // In Ait
            {
                ...
                // Clamp
                if (_currentVerticalSpeed < _fallClamp) _currentVerticalSpeed = _fallClamp; // The slowest we can be while falling
            }
        }
        ...
        private bool CanUseCoyote => _coyoteUsable
            && !_colDown
            && _timeLeftGrounded + _coyoteTimeThreshold > Time.time;
